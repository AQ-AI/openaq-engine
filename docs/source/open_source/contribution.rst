...
Commit messages must follow the `Angular-style <https://github.com/angular/angular.js/blob/master/CONTRIBUTING.md#commit-message-format>`_ commit format (but excluding the scope).
...
Ensure to use `black <https://github.com/psf/black>`_ and `flake8 <https://flake8.pycqa.org/en/latest/>`_.
